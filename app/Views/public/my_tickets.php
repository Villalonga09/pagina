  ...
  <?php if (!empty($tickets)): ?>
    ...
    <?php if (!empty($payments)): ?>
      ...
      <table class="table card-table">
        ...
        ?>
          <tr>
            <td><?= Utils::e($p['method'] === 'pago_movil' ? 'Pagomovil' : $p['method']) ?></td>
            <td><span class="badge <?= $stClass ?>"><?= Utils::e($p['status']) ?></span></td>
            <td><?= Utils::e($p['reference']) ?></td>
            <td>
              <?php if (!empty($p['receipt_path'])): ?>
                <button type="button" class="btn-slim btn-view-receipt view-receipt" data-img="/file/receipt/<?= Utils::e($p['receipt_path']) ?>">Ver comprobante</button>
              <?php else: ?>
                —
              <?php endif; ?>
            </td>
